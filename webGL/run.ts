...
// external delcerations
declare function makePerspective(fov, r, f, b);
declare function $V(a);
...
function initWebGL(canvas) {
    ...
    if (!!((<any>window).WebGLRenderingContext) == true) {
...
function initBuffers() {
    ...
    gl.bufferData(gl.ELEMENT_ARRAY_BUFFER,
        new Uint16Array(polys.indices), gl.STATIC_DRAW);
}
